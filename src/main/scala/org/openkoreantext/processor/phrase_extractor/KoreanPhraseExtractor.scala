...
import org.openkoreantext.processor.util.{Hangul, KoreanDictionaryProvider, KoreanPos}
...
object KoreanPhraseExtractor {
  ...
  protected[processor] def collapsePos(tokens: Seq[KoreanToken]): Seq[KoreanPhrase] = {
