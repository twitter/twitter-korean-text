...
public class JavaOpenKoreanTextProcessorExample {
  public static void main(String[] args) {
    ...
    System.out.println(OpenKoreanTextProcessorJava.tokensToJavaStringList(stemmed));
    // [한국어, 를, 처리, 하다, 예시, 이다, ㅋㅋ, #한국어]
    System.out.println(OpenKoreanTextProcessorJava.tokensToJavaKoreanTokenList(stemmed));
